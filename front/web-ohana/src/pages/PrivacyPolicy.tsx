    ...
    <main className="max-w-4xl mx-auto px-4 py-16 text-gray-800">
      ...
      <section className="space-y-6 leading-relaxed text-lg">
        <p>
          ...
          <br />
          <b>ROCÍO RUIZ ROJO</b>, en adelante RESPONSABLE, es el responsable del
          tratamiento de los datos personales del Usuario y le informa que estos
          datos serán tratados de conformidad con el Reglamento (UE) 2016/679
        ...
        <p>
          ...
          necesario para responder la solicitud. No se almacenan datos en bases
        ...
        <p>
          ...
          <br />
          El RESPONSABLE aplica las medidas técnicas y organizativas necesarias
          para proteger los datos personales conforme a la normativa vigente.
        </p>
      </section>
    </main>
  );
